        ...
        <Collapse in={connect.isOpen} animateOpacity>
            <Box m='1'>
                <HStack
                    ...
                    alignItems='flex-end'
                >
                    <Input labelName='Connect String:' placeHolder='Enter federation connection string' value={inputString} onChange={(event) => handleInputString(event)} />
                    <Button label='Connect 🚀' borderRadius='4' onClick={() => console.log('clicked')} height='48px' disabled={true} />
                </HStack>
            </Box>
        </Collapse>
    );
